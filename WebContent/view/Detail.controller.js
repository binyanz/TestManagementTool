sap.ui.controller("HelloWorldUI5.view.Detail", {
    
    onInit : function(){
      
      this.getOwnerComponent().attachEvent("tpTableRowSelectionChange",jQuery.proxy(this.onRowSelect,this));
      
      var oModel = new sap.ui.model.odata.ODataModel("HelloWorldUI5/services/poWorklistJoin.xsodata/", false);
      this.getView().setModel(oModel);
      oModel.setDefaultCountMode("Inline");
      
      var oController = this;
    
    //need to do that after adding pie
